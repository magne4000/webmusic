	...
	var methods = {
		...
		add : function(track, uniqidhead) {
			return this.each(function() {
				...
				if (!!track.id) {
					s = $('<tr></tr>')
						.append('<td><div class="text"><div class="handle"></div>' + track.name + '<div class="actionhandler"></div></div></td>')
					...
					while (!end) {
						s = $('<tr></tr>')
						.append('<td><div class="text"><div class="handle"></div>' + elt.name + '<div class="actionhandler"></div></div></td>')
