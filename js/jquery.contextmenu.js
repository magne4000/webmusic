...
;(function($){
    ...
    $.contextMenu = {
        ...
        create: function(menu,opts) {
            ...
            $.contextMenu.instances.push(cmenu);
        ...
        createMenuItem: function(label,obj) {
            ...
            var iconStyle = (o.icon)?'background-image:url('+o.icon+');':'',
                ...
                $idiv = $('<div class="'+cmenu.innerDivClassName+'" style="'+iconStyle+'">'+label+'</div>');
            $div.append($idiv);
            return $div;
        },
        ...
        hide: function(hideActive) {
            ...
            if (cmenu.shown) {
                ...
                $('.ui-selected .active').removeClass('active');
            }
            cmenu.shown = false;
        }
    };
    ...
    $.fn.contextMenu = function(method) {
        ...
        if (methods[method]) {
            ...
            $.error('jQuery.contextMenu: Method ' + method + ' does not exist');
        }
    };
})(jQuery);